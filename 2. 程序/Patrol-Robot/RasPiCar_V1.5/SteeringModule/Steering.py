...
class Steering:
    def __init__(self, channelP=default_channelP, min_thetaP=60, max_thetaP=180, init_thetaP=120, channelY=default_channelY, min_thetaY=0, max_thetaY=180, init_thetaY=84):
