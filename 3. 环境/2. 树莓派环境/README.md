<!--
 * @Author: Ken Kaneki
 * @Date: 2021-06-03 23:21:34
 * @LastEditTime: 2021-06-03 23:26:42
 * @Description: README
 * @FilePath: \undefinedd:\Learn\毕设资料\终期答辩\3. 环境\2. 树莓派环境\README.md
-->
# 使用步骤
    依次查看系统安装、开机配置、paddleLite部署完成树莓派端的环境配置
## 系统安装
    本部分主要叙述如何安装树莓派官方64位系统，版本在不断更新，安装最新版本即可
## 开机配置
    本部分为安装系统之后的基本配置，主要包括WIFI设置、摄像头设置、浏览器、VSCode、中文输入法等
## paddleLite部署
    本部分最为关键，目的是搭建预测模型运行环境，包括paddleLite和OpenCV编译安装、paddleLite预测工程搭建、paddleLite、OpenCV和mjpg-streamer联调
